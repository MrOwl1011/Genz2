...
class UserPrefsProvider extends ChangeNotifier {
  ...
  PlayerEngine _playerEngine = defaultPlayerEngine;
  ...
  PlayerEngine get playerEngine => _playerEngine;
  ...
  Future<void> setPlayerEngine(PlayerEngine engine) async {
    ...
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString('player_engine', engine.id);
    notifyListeners();
  }
  ...
  Future<void> init() async {
    ...
    // Load Player Engine
    _playerEngine = playerEngineFromId(prefs.getString('player_engine'));
