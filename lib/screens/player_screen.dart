    ...
    try {
      ...
      if (!_currentIsLive) {
        ...
        if (targetPos > 0) {
          ...
          int playWaits = 0;
          while (_player!.state.position.inMilliseconds == 0 &&
              playWaits < 40 &&
              mounted) {
            await Future.delayed(const Duration(milliseconds: 50));
            playWaits++;
          ...
          debugPrint(
            '[Player History] Current Position After Seek: ${_player!.state.position.inMilliseconds} ms',
          );
        }
      }
        ...
        body: Stack(
          ...
          children: [
            ...
            if (_showControls && !_isLocked)
              _buildControlsOverlay(appDirection),
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            height: 64,
            decoration: BoxDecoration(
              color: AppColors.dark.brandPrimary.withValues(alpha: 0.9),
              shape: BoxShape.circle,
              boxShadow: [
                BoxShadow(
                  color: AppColors.dark.brandPrimary.withValues(alpha: 0.4),
                  blurRadius: 20,
                  spreadRadius: 2,
                ),
              ],
          ...
          Expanded(
            child: SliderTheme(
              data: SliderThemeData(
                ...
                activeTrackColor: AppColors.dark.brandPrimary,
                inactiveTrackColor: Colors.white24,
                thumbColor: AppColors.dark.brandPrimary,
                overlayColor: AppColors.dark.brandPrimary.withValues(alpha: 0.2),
              ),
              child: Slider(
          ...
          children: [
            SizedBox(
              ...
              child: CircularProgressIndicator(
                valueColor: AlwaysStoppedAnimation<Color>(AppColors.dark.brandPrimary),
                strokeWidth: 3,
              ),
            ),
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: AppColors.dark.brandPrimary,
                      padding: const EdgeInsets.symmetric(
                        horizontal: 24,
                        vertical: 12,
                      ),
...
class _SettingsSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColors.dark.surfaceElevated,
  ...
  Widget _buildSettingsSection(
    ...
    return ListTile(
      leading: Icon(icon, color: AppColors.dark.brandPrimary, size: 24),
      title: Text(
        title,
        style: GoogleFonts.outfit(
          color: Colors.white,
          ...
          ...speeds.map(
            (s) => ListTile(
              ...
              trailing: s == playbackSpeed
                  ? Icon(Icons.check_rounded, color: AppColors.dark.brandPrimary)
                  : null,
              onTap: () {
