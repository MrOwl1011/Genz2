...
class MoreScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final currentEngineLabel =
        isArabic ? userPrefs.playerEngine.labelAr : userPrefs.playerEngine.label;
            ...
            children: [
              ...
              _buildInfoContainer([
                ...
                _buildActionRow(
                  ...
                  label: isArabic ? 'محرك التشغيل' : 'Player Engine',
                  value: currentEngineLabel,
                  onTap: () => _showPlayerEnginePicker(context, userPrefs, isArabic),
                ),
                _buildSwitchRow(
                  context,
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              padding: const EdgeInsets.all(16),
              child: Text(
                isArabic ? 'اختر محرك التشغيل' : 'Select Player Engine',
                style: GoogleFonts.outfit(
                  color: Colors.white,
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
            ...
            const Divider(color: Colors.white10, height: 1),
            for (final engine in availablePlayerEngines)
              _buildPlayerEngineOption(
                ctx,
                userPrefs,
                engine: engine,
                isArabic: isArabic,
  ...
  Widget _buildPlayerEngineOption(
    BuildContext context,
    UserPrefsProvider userPrefs, {
    required PlayerEngine engine,
    required bool isArabic,
  }) {
    final isSelected = userPrefs.playerEngine == engine;
    return ListTile(
      title: Text(
        isArabic ? engine.labelAr : engine.label,
        style: GoogleFonts.outfit(
          color: isSelected ? Theme.of(context).primaryColor : Colors.white,
          fontWeight: FontWeight.w600,
          fontSize: 16,
      ...
      trailing: isSelected
          ...
          : null,
      onTap: () {
        userPrefs.setPlayerEngine(engine);
        Navigator.pop(context);
      },
    );
  }
