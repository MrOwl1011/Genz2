...
function generate_pairing_code(string $accountId): array
{
    ...
    // Collisions are astronomically unlikely at 8 chars from a 32-symbol
    // alphabet, but a short retry loop costs nothing and removes the theoretical
    // failure mode entirely rather than trusting probability.
