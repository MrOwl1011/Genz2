...
// Digits only, by request — easier to read off one screen and type on
// another (especially on a TV remote's number pad) than mixed
// alphanumeric. Keyspace is smaller (10^4 = 10,000 vs the previous
// mixed-alphabet 32^4 ≈ 1.05M) — join.php's rate limit
// (PAIRING_JOIN_RATE_LIMIT_MAX per PAIRING_JOIN_RATE_LIMIT_WINDOW) is what
// actually keeps brute-forcing impractical, not the alphabet size alone;
// re-check that limit is still adequate before shrinking this further.
const PAIRING_CODE_ALPHABET = '0123456789';
